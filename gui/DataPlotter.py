...
class DataPlotter(QObject):
    ...
    def get_rxq3_temperature_plot(self):
        return DataPlotter("Chip internal temperature of RXQ3 transceiver", "Temperature, Celsius degrees",
    ...
    def get_on_board_computer_RAM_usage_plot(self):
        return BarChart("RAM usage", "Usage, %", self.get_data_for_plotting(
            "./telemetry_log_files/On-board_computer_telemetry_log.csv", "RAM_usage"))
